...
export default function Testimonials() {
  ...
  return (
    <section>
      <div className="mx-auto max-w-screen-xl px-4 py-12 md:px-6 lg:px-8 lg:py-16">
        <h2 className="text-center text-4xl font-bold tracking-tight text-gold-500 md:text-5xl">
          Read trusted reviews from our customers
        </h2>

        <div className="mt-8 [column-fill:_balance] md:columns-2 md:gap-6 lg:columns-3 lg:gap-8">

          <div>
            {testimonials.map((testimonial, index) => (
              <div key={index} className="mb-8 md:break-inside-avoid">
                <blockquote className="rounded-3xl bg-white py-4 px-3 shadow-sm md:p-8">
