      ...
      <div className="max-w-full px-4 mx-auto">
        <div className="py-12 h-5/6">
          ...
          <div className="w-full mx-auto text-center pb-6">
            <h2 className="mb-4 font-bold text-2xl md:text-3xl lg:text-7xl ">Trusted by <span className="text-gold-500 px-3 md:px-0">The Best</span> </h2>
          </div>
          ...
          <div className="flex flex-col items-center justify-center md:px-12">
            ...
            <div className="flex flex-wrap md:flex-nowrap items-center justify-evenly md:gap-2 md:justify-between lg:justify-center md:px-4">
