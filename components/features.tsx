        ...
        <div className="py-12 h-5/6">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center md:px-12">
            <div className="flex flex-wrap md:flex-nowrap lg:flex-col items-center justify-evenly md:gap-2 md:justify-between lg:justify-center md:mr-6">
              <MiniCard cardTitle="Low Cost" icon={Coin} description="Take advantage of low entry cost, now buy gold/silver starting from Rs.1." />
              ...
              <MiniCard cardTitle="Convenient Payments" icon={Payment} description="Pay by UPI, Internet Banking, Credit/debit card, Wallets and EMI" />
              <MiniCard cardTitle="24/7 Access" icon={Access247} description="Buy, sell and trade, even when the markets are closed" />
            </div>
            <div className="flex flex-wrap md:flex-nowrap lg:flex-col items-center justify-evenly md:gap-2 md:justify-between lg:justify-center md:mr-6">
              <MiniCard cardTitle="Physically Secure Locations" icon={Locker} description="Enjoy peace of mind knowing that your metal is stored in highly secure SEBI certified vaults" />
            ...
            <div className="flex flex-wrap md:flex-nowrap lg:flex-col items-center justify-evenly md:gap-2 md:justify-between lg:justify-center md:mr-6">
              ...
              <MiniCard cardTitle="High Liquidity" icon={Liquidity} description="Cash out and receive funds on the next business day" />
              <MiniCard cardTitle="Regularly Audited" icon={AuditCheck} description="Metals undergo regular internal and independent trustee audit" />
              <MiniCard cardTitle="Fully Insured" icon={Safe} description="Rest assured knowing that your metal is fully insured by top insurer" />
            </div>
          </div>
