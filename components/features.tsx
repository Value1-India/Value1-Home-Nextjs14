    ...
    <section>
      <div className="w-full px-4 sm:px-6">
        <div className="py-12 md:py-20 h-5/6">
          ...
          {/* Section header */}
          <div className="max-w-5xl mx-auto text-center pb-8 md:pb-20">
            <h2 className="md:mb-4 font-bold text-2xl lg:text-7xl ">Why Our Customers Love <span className="text-gold-500">Value1</span></h2>
          </div>

          {/* Items */}
          <div className="flex flex-col md:flex-row items-center justify-center ">
            <div className="flex flex-wrap md:flex-col items-center justify-evenly md:justify-center md:mr-6">
