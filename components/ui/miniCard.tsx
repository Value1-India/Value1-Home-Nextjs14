...
const MiniCard: React.FC<MiniCardProps> = ({ cardTitle, icon, description })=> {
  return (
    <div data-aos='fade-down' data-aos-delay='400' className='overflow-hidden w-32 h-auto md:w-36 xl:w-40 mb-4 text-black-600 bg-white rounded-3xl p-3 md:p-5 flex flex-col items-center justify-center card'>
